...
//     { icon: <FiRepeat />, label: 'Transactions', active: false },
//     { icon: <FiPieChart />, label: 'Statistics', active: false },
...
//           <div 
//             key={index}
//             className={`flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer transition-colors ${item.active ? 'bg-slate-100 text-slate-900' : 'text-slate-500 hover:bg-slate-50'}`}
//           >
