...
//         {role === 'admin' && (
//           <Button onClick={() => alert("Add Transaction Modal Logic Here")}>
//             <div className="flex items-center gap-2"><FiPlus /> Add New</div>
//           </Button>
//         )}
//       </div>
...
//           <button onClick={() => setFilter('all')} className={`px-4 py-1.5 rounded-full text-xs font-semibold ${filter === 'all' ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-600'}`}>All</button>
//           <button onClick={() => setFilter('income')} className={`px-4 py-1.5 rounded-full text-xs font-semibold ${filter === 'income' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'}`}>Income</button>
//           <button onClick={() => setFilter('expense')} className={`px-4 py-1.5 rounded-full text-xs font-semibold ${filter === 'expense' ? 'bg-rose-100 text-rose-700' : 'bg-slate-100 text-slate-600'}`}>Expense</button>
//         </div>
...
//                   {t.type === 'income' ? <FiArrowDownLeft className="text-emerald-500" /> : <FiArrowUpRight className="text-rose-500" />}
